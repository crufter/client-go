...
func currentMigrationRules() map[string]string {
	oldRecommendedHomeFile := filepath.Join(os.Getenv("HOME"), "/.kube/.kubeconfig")
	oldRecommendedWindowsHomeFile := filepath.Join(os.Getenv("HOME"), RecommendedHomeDir, RecommendedFileName)
